...
int main( int argc, const char* argv[] ){
  ...
  for (unsigned int isam = 0; isam < NSAMPLES; isam++){
    ...
    //std::cout<<(TString)("Getting "+inDir+fileName+":/"+inPref+"/Mu/"+inName+"_"+inPref+"_"+allNames[isam]+"_Mu")<<std::endl;
...
//   TLegend * leg = new TLegend(0.67, 0.58, 0.89, 0.93, "","brNDC");
  ...
  std::cout<<"Total Data/MC = "<<histos.at(Data)->Integral()/h_lumiBand->Integral()<<std::endl;
