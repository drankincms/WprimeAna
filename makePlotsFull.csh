...
foreach dir (Run2016_Feb20_Slim/)
  foreach chan (Mu El)
    ...
    #foreach prefix (Ex0BTags)
       ...
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix METJetdPhi 1 '${po}Delta${po}phi${lp}MET,leading\ jet${rp}' 50 0 ${scale}
       ...
       if ($chan == Mu ) eval ./DrawOneHistoThreeSig.o $dir $chan $prefix LepPhi 0 '${po}phi${lp}${po}mu${rp}' 25 0 ${scale}
       if ($chan == El ) eval ./DrawOneHistoThreeSig.o $dir $chan $prefix LepPhi 0 '${po}phi${lp}e${rp}' 25 0 ${scale}
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix AK4Jet1Phi 0 '${po}phi${lp}jet1${rp}' 50 0 ${scale}
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix AK4Jet2Phi 0 '${po}phi${lp}jet2${rp}' 50 0 ${scale}
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix AK4Jet3Phi 0 '${po}phi${lp}jet3${rp}' 50 0 ${scale}
       ...
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix dPhiWTop 1 '${po}Delta${po}phi${lp}W,jet_\{top\}${rp}' 50 0 ${scale}
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix dPhiWWprime 1 '${po}Delta${po}phi${lp}W,jet_\{b\}${rp}' 50 0 ${scale}
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix dRJet1Jet2 1 '${po}DeltaR${lp}jet1,jet2${rp}' 20 0 ${scale}
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix dRLepJet1 1 '${po}DeltaR${lp}lepton,jet1${rp}' 20 0 ${scale}
       eval ./DrawOneHistoThreeSig.o $dir $chan $prefix dRLepJet2 1 '${po}DeltaR${lp}lepton,jet2${rp}' 20 0 ${scale}
       ...
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix LepJetpTrel 1 'p_\{T\}^\{rel\}${lp}lepton,closest\ jet${rp}' 25 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix METLepdPhi 1 '${po}Delta${po}phi${lp}MET,lepton${rp}' 50 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix METJetdPhi 1 '${po}Delta${po}phi${lp}MET,leading\ jet${rp}' 50 0 ${scale}
       ...
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AllJetPt 1 'p_\{T\}${lp}all\ jets${rp}' 50 0 ${scale}
       ...
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet3Pt 1 'p_\{T\}${lp}jet3${rp}' 50 0 ${scale}
       if ($chan == Mu ) eval ./DrawOneHistoSigRatio.o $dir $chan $prefix LepEta 0 '${po}eta${lp}${po}mu${rp}' 25 0 ${scale}
       if ($chan == El ) eval ./DrawOneHistoSigRatio.o $dir $chan $prefix LepEta 0 '${po}eta${lp}e${rp}' 25 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet1Eta 0 '${po}eta${lp}jet1${rp}' 50 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet2Eta 0 '${po}eta${lp}jet2${rp}' 50 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet3Eta 0 '${po}eta${lp}jet3${rp}' 50 0 ${scale}
       if ($chan == Mu ) eval ./DrawOneHistoSigRatio.o $dir $chan $prefix LepPhi 0 '${po}phi${lp}${po}mu${rp}' 25 0 ${scale}
       if ($chan == El ) eval ./DrawOneHistoSigRatio.o $dir $chan $prefix LepPhi 0 '${po}phi${lp}e${rp}' 25 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet1Phi 0 '${po}phi${lp}jet1${rp}' 50 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet2Phi 0 '${po}phi${lp}jet2${rp}' 50 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet3Phi 0 '${po}phi${lp}jet3${rp}' 50 0 ${scale}
       ...
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix nBTags 1 '${po}\ b-tags' 1 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix nBTags_First2 1 '${po}\ b-tags\ ${lp}leading\ 2\ p_\{T\}\ jets${rp}' 1 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix dPhiWTop 1 '${po}Delta${po}phi${lp}W,jet_\{top\}${rp}' 50 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix dPhiWWprime 1 '${po}Delta${po}phi${lp}W,jet_\{b\}${rp}' 50 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix dRJet1Jet2 1 '${po}DeltaR${lp}jet1,jet2${rp}' 20 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix dRLepJet1 1 '${po}DeltaR${lp}lepton,jet1${rp}' 20 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix dRLepJet2 1 '${po}DeltaR${lp}lepton,jet2${rp}' 20 0 ${scale}
       eval ./DrawOneHistoSigRatio.o $dir $chan $prefix AK4Jet1Jet2Pt 1 'p_\{T\}${lp}jet1,jet2${rp}' 50 0 ${scale}
