...
//TLatex *t1temp=0;
 ...
 latex4->DrawLatex(0.27, 0.16, "95% CL Expected");



c1->Update();
c1->Print(Form("contour_arVSal-%s_expected150_final.pdf",chan.c_str()));
//c1->Print(Form("contour_arVSal-%s_expected150_final.C",chan.c_str()));
c1->Print(Form("contour_arVSal-%s_expected150_final.png",chan.c_str()));
c1->Print(Form("contour_arVSal-%s_expected150_final.ps",chan.c_str()));
c1->Print(Form("contour_arVSal-%s_expected150_final.jpeg",chan.c_str()));
