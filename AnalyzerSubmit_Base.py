...
indir = 'root://cmseos.fnal.gov//store/user/drankin/LJMet/Jan27_All'
...
for i in range(len(samples)):
    if (samples[i].startswith('WJets')):
        ...
        samples[i]=samples[i]+'_HF'


#samples = ['WJets_HT100to200_HF','WJets_HT100to200_LF']
#samples = ['Data']
...
for i in range(len(samples)):
        ...
        for line in csh_templ_file:
            ...
            line=line.replace('ANALYZER','WprimeAnalyzer')
            line=line.replace('OUTNAME','anOutFile')
